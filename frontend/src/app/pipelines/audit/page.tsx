...
import { ShieldCheck, Play, FileText, ExternalLink, Mail, User, Target, Briefcase } from 'lucide-react';
...
const GOALS = [
  { value: 'attract-clients', label: 'Attract Clients' },
  { value: 'build-authority', label: 'Build Authority' },
  { value: 'grow-following', label: 'Grow Following' },
...
export default function AuditPipeline() {
  ...
  const [goal, setGoal] = useState('attract-clients');
  ...
  const handleRun = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!targetUrl || !prospectName || !niche) return;
    ...
    <div className="p-4 md:p-8 max-w-5xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-6 md:mb-8 border-b border-slate-800 pb-4 md:pb-6">
        <h1 className="text-2xl md:text-3xl font-extrabold text-white flex items-center gap-3">
          ...
          LinkedIn Audit & Strategy
        </h1>
        <p className="text-slate-400 mt-2 text-lg">
          Full 12-section audit — dimension scores, post analysis, benchmarks, 20 post ideas, and action plan.
        </p>
      </div>
            ...
            <form onSubmit={handleRun} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Dr. Staci Moore"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    <Target className="absolute left-3 top-3.5 w-4 h-4 text-slate-500 pointer-events-none" />
                    <select
                      className="w-full bg-slate-950 border border-slate-700 rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all appearance-none cursor-pointer"
                      value={goal}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-700 rounded-xl pl-10 pr-4 py-3 text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                      value={niche}
              ...
              <button
                type="submit"
                disabled={isRunning || !targetUrl || !prospectName || !niche}
              ...
              >
                ...
                {isRunning ? 'Pipeline Running...' : 'Run Full Audit'}
              </button>
            </form>
          </div>
